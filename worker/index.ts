...
const PROMOTION_MILESTONES: PromotionMilestone[] = [
  ...
  {
    rankName: "BI Developer",
    requiredMissionIds: biDeveloperMissions.map((m) => m.id),
    nextRank: "Analytics Engineer",
  },
  {
    rankName: "Analytics Engineer",
    requiredMissionIds: analyticsEngineerMissions.map((m) => m.id),
    nextRank: "Data Engineer",
  },
  {
    rankName: "Data Engineer",
    requiredMissionIds: dataEngineerMissions.map((m) => m.id),
    nextRank: "Staff Analyst",
  },
  {
    rankName: "Staff Analyst",
    requiredMissionIds: staffAnalystMissions.map((m) => m.id),
    nextRank: "Principal Analyst",
  },
];
