...
export const sa017: Mission = {
  id: "sa-ticket-017",
  world: "AstraMind Analytics",
  levelLabel: "Ticket SA-017 // Priority: High",
  npc: "VP OF DATA SCIENCE ANIKA SHARMA",
  briefing: [
    "09:00 AM. Priority: High.",
    "\"New module \u2014 A/B testing. You ran an experiment: 10 users in control, 10 in treatment. Start with the group summary: how many users, converters, and total revenue per variant.\"",
  ],
  objective:
    "For each variant, show user count, converter count, and total revenue \u2014 sorted by variant.",
...
`,
  ...
  expectedColumns: ["variant", "users", "converters", "total_revenue"],
  expectedRows: [
    ["control", 10, 5, 300],
    ["treatment", 10, 7, 600],
  ],
  ...
  hints: [
    ...
    "Try: SELECT variant, COUNT(*) AS users, SUM(converted) AS converters, SUM(revenue) AS total_rev...",
  ],
  xpAward: 200,
};
