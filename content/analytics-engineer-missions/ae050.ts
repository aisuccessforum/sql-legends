...
export const ae050: Mission = {
  id: "ae-ticket-050",
  world: "AstraMind Analytics",
  levelLabel: "Ticket AE-050 // Final Assessment 8 of 8",
  npc: "DATA PLATFORM LEAD ARYAN KAPOOR",
  briefing: [
    "04:00 PM. Final Assessment.",
    "\"Grand finale — the complete Analytics Engineer pipeline. Three staged tables. Three CTEs: stg_confirmed (enrich + filter), int_metrics (aggregate by category+segment), fct_report (add margin_pct, share of category, rank within category). Eight output columns. This is the model that goes into production.\"",
    "\"After this: Data Engineer.\"",
  ],
  objective:
    "Build the complete 3-CTE pipeline and return: category, segment, units, revenue, gross_margin, margin_pct (1 decimal), pct_of_category (1 decimal), rank_in_category — sorted by category then revenue descending.",
