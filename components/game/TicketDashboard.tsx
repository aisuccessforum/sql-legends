...
export default function TicketDashboard({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:py-12">
      {certificateNumber && (
        <a
          href={`/certificate?number=${encodeURIComponent(certificateNumber)}`}
          className="console-card mb-8 flex items-center justify-between gap-4 px-6 py-5 transition-all hover:opacity-90"
          style={{
